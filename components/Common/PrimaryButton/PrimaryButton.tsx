    ...
    <button
      className={
        alternateButton
          ...
          : "z-10 relativ inline-block w-full md:w-auto mb-2 py-4 px-8 mr-4 text-sm text-white font-medium leading-normal bg-red-400 hover:bg-red-300 rounded transition duration-200"
      }
      onClick={onClick}
    >
      {text}
