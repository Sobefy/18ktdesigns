...
const PrimaryButton = ({
  ...
  return (
    <button
      className={
        ctaCollageButton
          ? "inline-block py-4 px-8 text-sm text-white font-medium leading-normal bg-red-400 hover:bg-red-300 transition duration-200 rounded transition duration-200"
          : ctaButton
          ? "inline-block ml-auto w-full md:w-auto px-12 py-4 text-center text-sm text-white font-medium leading-normal bg-red-400 hover:bg-red-300 rounded transition duration-200"
          : alternateButton
